...
// testWatcherReloadDelay defines the delay we expect for the watcher to
// reload the certificate keypair after the files have been updated.
const testWatcherReloadDelay = watcherCoalesceWindow + 100*time.Millisecond
